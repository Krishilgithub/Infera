...
const comparisonFeatures = [
  {
    ...
    features: [
      { name: 'Monthly meetings', free: '5', pro: 'Unlimited', enterprise: 'Unlimited' },
      { name: 'Real-time transcription', free: '✓', pro: '✓', enterprise: '✓' },
      { name: 'Speaker identification', free: '✓', pro: '✓', enterprise: '✓' },
      { name: 'Emotion tracking', free: 'Basic', pro: 'Advanced', enterprise: 'Advanced' },
      { name: 'Meeting summaries', free: '✓', pro: '✓', enterprise: '✓' },
      { name: 'Action items', free: 'Basic', pro: 'Smart', enterprise: 'Smart' }
    ]
  },
  {
    category: 'AI & Analytics',
    features: [
      { name: 'Sentiment analysis', free: 'Basic', pro: 'Advanced', enterprise: 'Advanced' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <Card className={`h-full ${plan.popular ? 'ring-2 ring-navy-500 shadow-lg' : ''}`}>
