...
const features = [
	{
		...
		description:
			"Get accurate, live transcriptions with speaker identification and timestamps.",
		benefits: [
			"99.2% accuracy rate",
	...
	},
	{
		...
		description:
			"Identify who said what and track participation levels across your team.",
		benefits: [
	...
	},
	{
		...
		description:
			"Understand team dynamics with AI-powered emotion and sentiment tracking.",
		benefits: [
	...
	},
	{
		...
		description:
			"Get instant explanations for technical terms and industry jargon.",
		benefits: [
	...
	},
	{
		...
		description:
			"Automatically generated meeting summaries with key points and decisions.",
		benefits: [
	...
	},
	{
		...
		description:
			"Automatically create tasks, schedule follow-ups, and sync with your tools.",
		benefits: [
			"Task creation",
...
const additionalFeatures = [
	...
	},
	{
		...
		description:
			"Track meeting effectiveness, duration trends, and productivity insights.",
	},
	{
		icon: Target,
		title: "Custom Workflows",
		description:
			"Create custom automation rules tailored to your team's processes.",
	},
	{
		icon: BarChart3,
		title: "Team Insights",
		description:
			"Understand team dynamics and collaboration patterns over time.",
	},
	{
		icon: MessageSquare,
		title: "Multi-platform Support",
		description:
			"Works with Zoom, Teams, Google Meet, and 20+ other platforms.",
	},
	{
		icon: TrendingUp,
		title: "ROI Tracking",
		description:
			"Measure the impact of your meetings on team productivity and outcomes.",
	},
];
			...
			<div className="container">
						...
						return (
							...
							>
								...
								<div className={isEven ? "" : "lg:col-start-2"}>
									<div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-infera-100 to-rose-100 dark:from-infera-900 dark:to-rose-900 mb-6">
										<Icon className="h-8 w-8 text-infera-600 dark:text-infera-400" />
									</div>
								...
								<div className={isEven ? "" : "lg:col-start-1"}>
									<div className="relative rounded-2xl bg-gradient-to-br from-infera-50 to-rose-50 dark:from-infera-900 dark:to-rose-900 p-8 border">
										...
										<div
											className="absolute -bottom-2 -left-2 w-3 h-3 bg-infera-500 rounded-full animate-pulse"
							...
							return (
								...
								>
									<Card className="h-full hover:shadow-lg transition-shadow">
										<CardHeader>
											<div className="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br from-infera-100 to-rose-100 dark:from-infera-900 dark:to-rose-900 mb-4">
				...
				>
					...
					<p className="text-xl text-muted-foreground mb-8">
						Start your free trial today and see how Infera can transform your
						meetings.
					</p>
