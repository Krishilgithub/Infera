...
const LiveMeetingInterface: React.FC = () => {
	...
	const handleShareMeeting = () => {
		navigator.clipboard?.writeText(
			"https://meetingmonitor.com/join/123-456-789"
		);
						...
						<div key={i} className="relative group">
							...
							<div
								className={`relative h-full ${
									participant.bgColor
								} rounded-xl overflow-hidden shadow-lg border-2 ${
									participant.isHost
										? "border-yellow-300"
					...
					{[
						{
							...
							time: "14:02",
							text: "Let's start by reviewing our Q4 objectives and KPIs.",
							sentiment: "positive",
						},
						{
							speaker: "Michael Chen",
							time: "14:03",
							text: "The API performance metrics look great this quarter.",
							sentiment: "positive",
						},
						{
							speaker: "Emily Rodriguez",
							time: "14:04",
							text: "User feedback on the new interface has been overwhelmingly positive.",
							sentiment: "positive",
						},
						{
							speaker: "David Kim",
							time: "14:05",
							text: "I have some concerns about the conversion rates we need to address.",
							sentiment: "concerned",
						},
						{
							speaker: "Lisa Thompson",
							time: "14:06",
							text: "Marketing campaigns are exceeding our ROI expectations.",
							sentiment: "excited",
						},
					].map((entry, i) => (
						<div
