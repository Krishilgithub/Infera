...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: 'LinkedIn', icon: Linkedin, href: 'https://linkedin.com/company/infera' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              Transform your meetings with AI-powered transcription, emotion tracking, 
              and automated summaries. Make every meeting count.
            </p>
